...
.editor-header.fn-flex
	...
	.editor-header-right.fn-flex.pos-r(v-clickoutside="hideZoomMenu")
		d-svg.editor-header-play.cursor-pointer(@click="preview" v-if="manager.screen.currentScreen.show" type="el-icon-arrow-right" :size="20")
		d-svg.editor-header-play.cursor-pointer(@click="preview" v-else type="el-icon-arrow-left" :size="20")
...
export default defineComponent({
	...
	setup() {
		...
		const preview = () => {
      state.manager.screen.currentScreen.show = !state.manager.screen.currentScreen.show
